...
//  TopChartsApp
//
//  Created by Kir Pir on 10.09.2020.
...
struct Colors {
    ...
    static let darkGreen            = UIColor(red: 23.0/255.0, green: 61.0/255.0, blue: 28.0/255.0, alpha: 1.0)
    static let darkGreenCell            = UIColor(red: 23.0/255.0, green: 61.0/255.0, blue: 28.0/255.0, alpha: 0.4)
    static let lightGreen            = UIColor(red: 76.0/255.0, green: 125.0/255.0, blue: 50.0/255.0, alpha: 1.0)
}
